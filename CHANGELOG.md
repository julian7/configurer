...
* Watch didn't notify on subsequent config changes, as initial Notify was called already. Now Watch sends notification unconditionally.
...
[v0.2.1]: https://github.com/julian7/configurer/tag/v0.2.1
